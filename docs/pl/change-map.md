...
| Reguły przy rozwoju Orcana | `.cursor/rules/`, `AGENTS.md` | [Kontekst AI](ai/project-context.md) |
...
| Publiczny indeks docs dla agentów | `docs/llms.txt` (generowany) | [llms.txt](https://akyther.github.io/orcan/latest/llms.txt) |
...
Po zmianach config przy działającym kontenerze: `orcan sync && orcan down && orcan up`.
