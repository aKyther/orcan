...
Orcan to **orkiestrator kontekstu**. Uruchamia Cursor CLI (`agent`) i Claude Code (`claude`) w Dockerze z workspace'ami, montowaniem path-parity oraz terminalem w przeglądarce.
