...
| Rules while developing Orcan | `.cursor/rules/`, `AGENTS.md` | [AI project context](ai/project-context.md) |
...
| Public agent docs index | `docs/llms.txt` (generated) | [llms.txt](https://akyther.github.io/orcan/latest/llms.txt) |
