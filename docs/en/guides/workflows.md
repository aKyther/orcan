...
```bash
orcan enter                 # cockpit: top bar + workspaces/ASSERTIONS | tmux + status
...
| arrows + Enter | Navigate / attach workspace (workspaces list focused) |

Inside the center terminal, **tmux shortcuts still apply** (prefix **C-Space**;
