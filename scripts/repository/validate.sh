...
require_file "scripts/repository/reconcile-host.py"
require_file "scripts/repository/workspace-audit.py"
require_file "tests/host/test_reconcile_host.py"
require_file "tests/host/test_workspace_audit.py"
...
require_file "docker/rootfs/etc/orcan/shell/workspace-history.sh"
require_file "tests/host/test_workspace_history.py"
